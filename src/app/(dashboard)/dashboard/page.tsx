  ...
  return (
    <div className='w-full'>
      ...
      <div className='w-full flex flex-col gap-4 my-4'>
        <Link id="deposit-money-button" href="/dashboard/cargar-dinero" className='w-full py-4 bg-[var(--color-primary)] shadow-gray-300 shadow-md rounded-md text-xl font-semibold text-center'>Ingresar dinero</Link>
